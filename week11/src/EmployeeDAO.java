...
public class EmployeeDAO {
	...
	public static boolean save(Employee employee) throws PersistentException {
		try {
			OrmtestPersistentManager.instance().saveObject(employee);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(Employee employee) throws PersistentException {
		try {
			OrmtestPersistentManager.instance().deleteObject(employee);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(Employee employee) throws PersistentException {
		try {
			OrmtestPersistentManager.instance().getSession().refresh(employee);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(Employee employee) throws PersistentException {
		try {
			OrmtestPersistentManager.instance().getSession().evict(employee);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
