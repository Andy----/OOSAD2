...
public class OrmtestPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "Ormtest";
	...
	private OrmtestPersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new OrmtestPersistentManager();
		}
